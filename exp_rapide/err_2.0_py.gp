...
set output './relative_err_graph/SR_2.0_iter_py.png'
...
set output './relative_err_graph/SR_2.0_rec_py.png'
...
set output './relative_err_graph/UR_2.0_iter_py.png'
...
set output './relative_err_graph/UR_2.0_rec_py.png'
