...
y=0.995
echo "# Creating folder results/SR_x_0_995.dat"
sudo docker run -v "$PWD":/workdir verificarlo/verificarlo verificarlo-c main.c -o main
sudo docker run -v "$PWD":/workdir -e VFC_BACKENDS="libinterflop_mca_int.so" verificarlo/verificarlo ./main "$y" > results/SR_x_0_995_$i.dat
rm -rf main.o main
