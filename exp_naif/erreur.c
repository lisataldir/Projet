...
int main(int argc, char ** argv) {
    ...
    ref2 = fopen("results/ref_x_0_5.dat", "r");
    ...
    // OUverture des trois fichiers contenant les valeurs de x^n pour SR
    FILE *SR1, *SR2, *SR3;
    float val_sr1, val_sr2, val_sr3;
    SR1 = fopen("results/SR_x_2.dat", "r");
    SR2 = fopen("results/SR_x_0_5.dat", "r");
    SR3 = fopen("results/SR_x_rand.dat", "r");
    if (SR1 == NULL || SR2 == NULL || SR3 == NULL) {
        perror("open");
        return 1;
    }
    
    // Création des trois fichiers qui vont contenir l'erreur SR
    FILE *errSR1, *errSR2, *errSR3;
    float err_sr1_val, err_sr2_val, err_sr3_val;
    errSR1 = fopen("results/errSR_x_2.dat", "w");
    errSR2 = fopen("results/errSR_x_0_5.dat", "w");
    errSR3 = fopen("results/errSR_x_rand.dat", "w");
    ...
    UR2 = fopen("results/UR_x_0_5.dat", "r");
    ...
    errUR2 = fopen("results/errUR_x_0_5.dat", "w");
