        ...
        with open(elaps_path, 'a') as elaps_file:
            for line in file:
                ...
                if len(columns) == 4:
                    ...
                    print("Elaps ",difference)
                    elaps_file.write(str(difference)+"\n")
                else:
                    print("Error: Not enough columns in the line -", line.strip())
                    return


raw_data_paths = ["timing_UR/raw_naif.dat","timing_UR/raw_rapid.dat","timing_SR/raw_naif.dat","timing_SR/raw_rapid.dat","timing_UR/raw_sum.dat","timing_SR/raw_sum.dat"]
